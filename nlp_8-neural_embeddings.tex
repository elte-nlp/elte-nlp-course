...
\begin{slide}[toc=PMI]{Pointwise Mutual Information}
  ...
  PMI measures how much more or less words occure in each other's context than
...
The $\frac{P(w_i, w_j)}{P(w_i)P(w_j)}$ fraction in the PMI formula can be estimated as
\begin{small}
